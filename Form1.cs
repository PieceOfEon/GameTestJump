...
namespace GameTestJump
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            this.Height = 600;
            this.Width = 480;
            this.Paint+=new PaintEventHandler(OnRepiant);
        }
        public void Init()
        {
        ...
        {
            this.Text = "Doodle: Score - " + PlatformController.score;
        ...
        private void OnRepiant(object sender, PaintEventArgs e)
        {
